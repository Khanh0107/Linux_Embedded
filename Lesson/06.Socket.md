...
### 2.1 Flow operation of stream socket (TCP)
...
| 2    | `connect()` | Connect to the server's IP address and port |
...
## 2.2 Flow operation of Datagram Socket (UDP)
