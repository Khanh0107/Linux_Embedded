...
## 3. Steps to create character device drive 

1. Build **makefile**

[makefile](../Assignments/12_Character_device_driver/Example1/makefile)

2. Create the Driver Source File
3. Build the Module
...
- Loads the kernel module file

`dmesg -w`

- Display message. It shows the kernel log buffer.

5. Change the permission of the device file
   
`sudo chmod 666 /dev/m_device`

6. Operating with kernel
7. Remove the Module
